    ...
    "
        ...
        {!isCustomPedal && (
          <div className="flex items-center py-1">
            ...
            {/* VALUE */}
            <span
              className={`text-[9px] px-2 py-1 rounded-full font-black uppercase whitespace-nowrap ${(selectedPedal.status || "").toLowerCase().includes("active")
        ...
        {/* CIRCUIT */}
        {!isCustomPedal && hasValue(selectedPedal.circuit) && (
          <div className="flex items-center py-1">
        ...
        {/* BYPASS */}
        {!isCustomPedal && hasValue(selectedPedal.bypass) && (
          <div className="flex items-center py-1">
